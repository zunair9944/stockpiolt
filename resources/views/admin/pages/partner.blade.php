            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="quickForm" method="post" action="{{ route('update-partner') }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mataTitle" value="{{ $item->mataTitle }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mataDescription" value="{{ $item->mataDescription }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mataTags" value="{{ $item->mataTags }}" class="form-control"
                                        id="mataTags" placeholder="Enter Mata Tags">
                                    @error('mataTags')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
