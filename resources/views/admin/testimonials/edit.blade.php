      ...
      <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="post" action="{{@url('/admin/testimonial/update')}}" enctype="multipart/form-data">
                <div class="card-body">
                @csrf
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="subject" value="{{ $item->subject }}" class="form-control" id="subject" placeholder="Enter Subject">
                      @error('subject')
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="rating">
                        <input type="radio" {{ 5==$item->star_rating?'checked':''}} name="star_rating" value="5" id="5"><label for="5">☆</label>
                        <input type="radio" {{ 4==$item->star_rating?'checked':''}} name="star_rating" value="4" id="4"><label for="4">☆</label>
                        <input type="radio" {{ 3==$item->star_rating?'checked':''}} name="star_rating" value="3" id="3"><label for="3">☆</label>
                        <input type="radio" {{ 2==$item->star_rating?'checked':''}} name="star_rating" value="2" id="2"><label for="2">☆</label>
                        <input type="radio" {{ 1==$item->star_rating?'checked':''}} name="star_rating" value="1" id="1"><label for="1">☆</label>
                      </div>
                      @error('star_rating')
                      <div class="text-danger">{{ $message }}</div>
                      @enderror
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <textarea name="body" class="form-control" id="body" placeholder="Description">{{ $item->body }}</textarea>
                      @error('body')
                      <div class="text-danger">{{ $message }}</div>
                      @enderror
                    </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="client_name" value="{{ $item->client_name }}" class="form-control" id="client_name" placeholder="Enter Client Name">
                      @error('client_name')
                      <div class="text-danger">{{ $message }}</div>
                      @enderror
                    </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="designation" value="{{ $item->designation }}" class="form-control" id="designation" placeholder="Enter Designation">
                      @error('designation')
                      <div class="text-danger">{{ $message }}</div>
                      @enderror
                    </div>
